...
#Clip y estadísticas
def clip_tif(shpcuenca, path_tifUTM, path_out):
    list2 = glob.glob(path_tifUTM)
...
def media_anomalia(ChirpsUTM_clipped_folder,stats):
...
def cal_anomalia(ChirpsUTM_clipped_folder,anho_inicio,stats,path_out):
    list3 = glob.glob(ChirpsUTM_clipped_folder)
    for i in list3:
