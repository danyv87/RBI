...
#
from RBI.SPI_funciones import *

#Clip y estadísticas
clip_tif(shpcuenca, path_tifUTM, path_out)

#calcular media para anomalías
media_anomalia(ChirpsUTM_clipped_folder,stats)

#cálculo de anomalías
cal_anomalia(ChirpsUTM_clipped_folder,anho_inicio,stats)
